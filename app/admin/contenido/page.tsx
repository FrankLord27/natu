...
const SECTION_PRESETS: any = {
  ...
  seo_global: {
    ...
    description:
      "Palabras clave y títulos que ayudan a que tu sitio aparezca en búsquedas.",
    icon: <Globe size={20} />,
    default: {
      siteTitle: "NaturaJM - Tienda Natural",
      metaDescription: "La mejor selección de productos naturales y orgánicos.",
      keywords: "natural, salud, bienestar, tienda",
    },
  },
  contact_info: {
  ...
  legal_notice: {
    ...
    default: {
      privacyPolicy: "Tu privacidad es importante para nosotros...",
      terms: "Al usar este sitio aceptas...",
    },
  },
};
...
export default function AdminContenido() {
  ...
  const initializeWorkspace = async () => {
    if (!confirm("Esto creará las secciones básicas del sitio. ¿Continuar?"))
      return;
    setLoading(true);
    try {
      ...
      >
        ...
        >
          ...
          <h2 style={{ fontSize: "1.2rem", fontWeight: 800 }}>
            Guía ràpida del Editor
          </h2>
        </div>
        <p style={{ color: "#666", fontSize: "0.95rem", lineHeight: 1.5 }}>
          Usa esta herramienta para cambiar textos de tu web sin tocar código.
          Selecciona una sección del <strong>Catálogo</strong> o inicializa las
          ...
          {contentList.length === 0 ? (
            ...
            >
              ...
              <p style={{ color: "#999", marginBottom: 30 }}>
                Parece que no has configurado tus secciones. Haz clic abajo para
                lanzar las automáticas.
              </p>
              <SaveBtn
                onClick={initializeWorkspace}
                style={{ margin: "0 auto", padding: "15px 30px" }}
              >
            ...
            contentList.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <CardActions>
                    <DelIcon onClick={() => handleDelete(item.id)}>
                      <Trash2 size={16} />
                    </DelIcon>
      ...
      <AnimatePresence>
        {showModal && (
          ...
          >
            ...
            >
              <h2 style={{ fontWeight: 900, marginBottom: 15 }}>
                Añadir Nueva Sección
              </h2>
              <p
                style={{ fontSize: "0.85rem", color: "#666", marginBottom: 20 }}
              >
                Selecciona una sección del catálogo para empezar a editarla.
              </p>
              ...
              <div style={{ display: "grid", gap: 10 }}>
                {Object.keys(SECTION_PRESETS).map((key) => {
                  ...
                  return (
                    ...
                    >
                      <span style={{ color: "#7BB32E" }}>
                        {SECTION_PRESETS[key].icon}
                      </span>
                      <div>
                        <div style={{ fontWeight: 700, fontSize: "0.9rem" }}>
                          {SECTION_PRESETS[key].name}
                        </div>
                        <div style={{ fontSize: "0.75rem", color: "#999" }}>
                          {isExisting
                            ? "Ya añadida"
                            : SECTION_PRESETS[key].description}
                        </div>
                      </div>
                    </button>
                  );
