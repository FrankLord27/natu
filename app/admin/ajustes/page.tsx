...
export default function AdminAjustes() {
  ...
  return (
    <Page>
      ...
      <Section>
        <SectionTitle>
          <Globe size={20} /> Identidad de Marca
        </SectionTitle>
        <Grid>
          <FormGroup>
      ...
      <Section>
        <SectionTitle>
          <MessageCircle size={20} /> Canales de Contacto
        </SectionTitle>
        <Grid>
          <FormGroup>
      ...
      <Section>
        <SectionTitle>
          <Layout size={20} /> Logística y Pagos
        </SectionTitle>
        <Grid>
          <FormGroup>
          ...
          <FormGroup>
            ...
            <Input
              type="number"
              value={settings.minOrderFree}
              onChange={(e) =>
                handleChange("minOrderFree", parseFloat(e.target.value))
              }
            />
          </FormGroup>
        </Grid>
      ...
      <Section>
        <SectionTitle>
          <Shield size={20} /> Sistema y Seguridad
        </SectionTitle>
        <FormGroup style={{ display: "flex", alignItems: "center", gap: 15 }}>
          ...
          <div>
            ...
            <p style={{ fontSize: "0.8rem", color: "#999", margin: 0 }}>
              Activa esto para mostrar una página de {'"'}Volvemos pronto{'"'} a
              los clientes.
            </p>
          </div>
        </FormGroup>
