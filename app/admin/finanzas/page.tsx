...
const SalesTrendChart = dynamic(
  () =>
    import("@/components/admin/FinanceCharts").then(
...
const PredictiveCard = styled(GlassCard)`
  background: linear-gradient(
    135deg,
    ${(p) => p.theme.colors.primaryDark} 0%,
    #1a1a1a 100%
  );
  color: white;
  border: none;
...
export default function FinancialDashboard() {
  ...
  const { descriptive, diagnostic, predictive, chartData, recentEntries } =
    data;
      ...
      <StatsGrid>
        ...
        >
          ...
          <div
            ...
            style={{ color: diagnostic.momGrowth >= 0 ? "#7BB32E" : "#ff5252" }}
          >
            {diagnostic.momGrowth >= 0 ? (
              <TrendingUp size={16} />
            ) : (
        ...
        >
          ...
          <div className="comparison" style={{ color: "#7BB32E" }}>
            <Activity size={16} />{" "}
            {((descriptive.profit / descriptive.revenue) * 100).toFixed(1)}%
            Margen
          </div>
        </MetricCard>
        ...
        <RightColumn>
          ...
          >
            ...
            <div className="proj-value">
              ${predictive.projectedRevenue.toLocaleString()}
            </div>
            <p className="note">
              Basado en la tendencia actual, se estima un crecimiento del **
              {(
                (predictive.projectedRevenue / diagnostic.lastMonthRevenue -
                  1) *
                100
              ).toFixed(1)}
          ...
          >
              ...
              recentEntries.map((entry: any) => (
                <Entry key={entry.id}>
                  <div className="info">
                    <div className="icon">
                      {entry.type === "INCOME" ? (
                        <TrendingUp size={16} color="#7BB32E" />
                      ) : (
            ...
            <ActionBtn
              style={{ width: "100%", marginTop: 25, justifyContent: "center" }}
            >
