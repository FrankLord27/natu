...
const ReviewCard = styled(motion.div)<{ $isApproved: boolean }>`
  ...
  border: 1px solid ${(p) => (p.$isApproved ? "#e8f5e9" : "#fff3e0")};
  display: flex;
    ...
    <Page>
      <Header>
        ...
        <p style={{ color: "#666", fontWeight: 600 }}>
          Modera y responde a tus clientes para mejorar el SEO.
        </p>
      </Header>
      ...
      <SearchBar>
        ...
        <Input
          placeholder="Filtrar por contenido o producto..."
          value={searchTerm}
            ...
            >
              <ProductHeader>
                <div className="info">
                  ...
                  <div className="slug">
                    {r.isApproved ? "Publicada" : "Pendiente de aprobación"}
                  </div>
                </div>
              </ProductHeader>
