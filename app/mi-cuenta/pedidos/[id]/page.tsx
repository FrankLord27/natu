...
export default function PedidoDetalle() {
  ...
  if (loading) {
    return (
      <Page>
        <Container>
          <LoadingWrap>Cargando detalles...</LoadingWrap>
        </Container>
      </Page>
    );
  }
  ...
  if (!order) {
    return (
      <Page>
        <Container>
          <Header>
            <BackButton href="/mi-cuenta/pedidos">
              <ArrowLeft size={18} />
            </BackButton>
    ...
    <Page>
      <Container>
        ...
        <OrderStatusSection>
          <StatusHeader>
            <OrderId>
              Orden <span>#{order.orderNumber}</span>
            </OrderId>
        ...
        <Grid>
          ...
          <div>
            ...
            <Card>
              ...
              >
                La información de envío se gestiona directamente tras la
