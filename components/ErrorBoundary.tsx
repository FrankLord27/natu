      ...
      return (
        <ErrorContainer>
          ...
          >
            ...
            <Desc>
              Lo sentimos, Frank. Se ha producido un error inesperado al
              renderizar este componente. El equipo técnico (Agentes IA) ha sido
            ...
            {process.env.NODE_ENV === "development" && (
              <DebugPanel>
                <details>
                  <summary>
                    <Terminal size={14} /> Ver Detalles Técnicos (Debug)
                  </summary>
                  <pre>
